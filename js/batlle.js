...
drawBtn.addEventListener('click', () => {
    ...
    <div data-card-id="${card.id}" 
        class="my_deck w-44 flex flex-col gap-2 rounded-xl border-4 border-${card.rarityClass}-400 bg-component-dark p-2 transition-transform duration-300 hover:scale-[1.02]" draggable="true">
